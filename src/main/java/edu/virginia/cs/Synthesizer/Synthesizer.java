...
//						om.lastIndexOf("."));
		...
		HashMap<String, HashMap<String, CodeNamePair>> association = new HashMap<String, HashMap<String, CodeNamePair>>();
		HashMap<String, ArrayList<CodeNamePair>> primaryKeys = new HashMap<String, ArrayList<CodeNamePair>>();
		HashMap<String, ArrayList<CodeNamePair>> fields = new HashMap<String, ArrayList<CodeNamePair>>();
